...
groups_sheet = pd.read_csv('py/HackathonScrathDir-main/DataSheets/groups.csv')
rooms_sheet = pd.read_csv("py/HackathonScrathDir-main/DataSheets/rooms.csv")
